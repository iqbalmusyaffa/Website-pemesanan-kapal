            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title mt-3 ">
                        <h2>DAFTAR <span class="alternate">pemesanan Kapal</span></h2>
                    </div>
                </div>
            </div>

            <div class="icontambah mb-5" style="margin-left: 50px;">
                    <a class="btn btn-primary btn-sm" href="tambahpemesanan.php" role="button"
                        title="Tambah Tujuan">
                        &nbsp;<i class="fa fa-plus" aria-hidden="true"> <label class="p-2">Tambah pemesanan Kapal</label> </i>&nbsp;
                    </a>
            </div>
                        ...
                        <?php
                            ...
                            <td>
                                ...
                                <a href="cetakpemesanan2.php?id=<?php echo $data['id_pemesanan']; ?>" target="_BLANK">
                                        <button type="button" class="btn btn-warning btn-sm" title="Cetak Pemesanan">
                            ...
                            <td>
                                <?php
                                  if ($data['status']==1){
                                    echo '<p> <a href="?id='.$data['id_pemesanan'].'&status=0" class="btn btn-primary" disabled data-bs-toggle="button">Terima</a></p>';
                                  }
                                  else{
                                    echo '<p> <a href="?id='.$data['id_pemesanan'].'&status=1" class="btn btn-warning" disabled data-bs-toggle="button">Pending</a></p>';
                                  }
                                ?>
                             </td>
                        </tr>
