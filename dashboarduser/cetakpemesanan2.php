...
<?php
                    ...
                    INNER JOIN pembayaran ON pemesanan.pembayaran_id = pembayaran.id_pembayaran WHERE id_pemesanan='$id'
                    ");
                    $no = 1;
...
<td valign='top' style='font-size:12px;'><?php echo tanggal_indonesia($data1['tgl_aktif']) ?></td>
<td valign='top' style='font-size:12px;'><?php echo tanggal_indonesia($data1['tgl_berakhir']) ?></td>
...
<b><p>Pembayaran bisa melalui</p>
   <img src='../dashboardadmin/assets/img/pembayaran/dana.png' width='25%' height='50' />
   <b><p> No Dana : 087765079444</p><b>
   <img src='../dashboardadmin/assets/img/pembayaran/Cara-Pakai-OVO.jpg' width='25%' height='100' />
   <p> No OVO : 087765079444</p>
   <img src='../dashboardadmin/assets/img/pembayaran/linkaja.png' width='25%' height='100' />
   <p> No Link aja : 087765079444</p>
   <img src='../dashboardadmin/assets/img/pembayaran/1081027ebaed20dc6155d99946411a8721f1de6224d0b646a5c767072dfb1afb.png' width='25%' height='100' />
   <p> No Shoppepay : 087765079444</p>
   <img src='../dashboardadmin/assets/img/pembayaran/1200px-Bank_Central_Asia.svg.png' width='25%' height='100' />
