      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            ...
            <p class="fst-italic">
              Aplikasi ini menyediakan beberapa informasi tentang pemesanan tiket kapal.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> Terdapat beberapa pilihan kapal yang siap mengantarkan keluarga anda</li>
              <li><i class="bi bi-check-circle"></i> Pemesanan tiket ini mudah dipahami</li>
              <li><i class="bi bi-check-circle"></i> Tiket yang sediakan tidak terlalu mahal untuk sewanya</li>
            </ul>
            <p>
            Nikmati perjalanan ini dengan menyenangkan, dan dapatkan penawaran dan promo menarik!
            </p>
    ...
    <section id="counts" class="counts">
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-center">
            <div class="count-box">
              <i class="bi bi-emoji-smile"></i>
              <span data-purecounter-start="0" data-purecounter-end="6" data-purecounter-duration="1" class="purecounter"></span>
              <p><b>Jumlah User</b></p>
              <a href="index.php?hal=user">Selengkapnya &raquo;</a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-center">
            <div class="count-box">
              ...
              <p><b>Jumlah Kapal</b></p>
              <a href="index.php?hal=#">Selengkapnya &raquo;</a>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="assets/img/sponsor/pelni.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/sponsor/jnt.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/sponsor/sicepat.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/sponsor/kemenhub.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/sponsor/lion.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/sponsor/wahana.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/sponsor/tiki.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/sponsor/anteraja.png" class="img-fluid" alt=""></div>
          </div>
