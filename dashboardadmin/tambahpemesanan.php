...
<select class="form-select form-select-sm" aria-label=".form-select-sm example" name="nama_pemesanan">
...
<select class="form-select form-select-sm" aria-label=".form-select-sm example" name="methode_pembayaran">
...
<?php
    if (isset($_POST['btnsimpan'])) {
        ...
        $harga = $_POST['harga'];
        $status = $_POST['status'];
        $data = mysqli_query($konek, "INSERT INTO pemesanan (nama_pemesanan,nama_kategori_kapal,nama_kapal,nama_tujuan,methode_pembayaran,tgl_aktif,tgl_berakhir,harga_id,status) Values('$nama_pemesanan','$nama_kategori_kapal','$nama_kapal','$nama_tujuan','$methode_pembayaran','$tgl_aktif','$tgl_berakhir','$harga_id','$status')");
        if ($data) {
