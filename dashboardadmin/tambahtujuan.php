	...
	<div class="container">
		...
		<form action="" method="POST" class="row" enctype="multipart/form-data">
			<div class="col-md-6 mt-5">
				...
				<input type="text" class="form-control main" name="tujuan" id="nama" placeholder="Nama Tujuan">
			</div>
            <div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Deskripsi</label>
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="dekripsi" placeholder="masukan deskripsi"></textarea>
</div>
<div class="mb-3">
...
if (isset($_POST['btnsimpan'])) {
    ...
    if ($jenis_gambar == "image/jpeg" || $jenis_gambar == "image/jpg" || $jenis_gambar == "image/gif" || $jenis_gambar == "image/png") {
        ...
        if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $foto)) {
            $sql = ("INSERT INTO tujuan (tujuan,dekripsi,kategori_id,foto) 
            VALUES ('$tujuan','$dekripsi','$kategori_id','$foto')");
