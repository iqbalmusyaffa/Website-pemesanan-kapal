		...
		<div class="row">
			<div class="col-12 text-center">
				<div class="title mt-5">
					<h3>Input Data Kapal</h3>
				</div>
				<ol class="breadcrumb justify-content-center p-0 m-0">
				  <li class="breadcrumb-item"><a href="index.php?hal=home">Home</a></li>
                  <li class="breadcrumb-item active">Data Kapal</li>
                  <li class="breadcrumb-item active">Data Kapal</li>
				  <li class="breadcrumb-item active">Input Data Kapal</li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="section-title">
					<h3>Input <span class="alternate">Data Kapal</span></h3>
				</div>
			</div>
		</div>
		<form action="" method="POST" class="row" enctype="multipart/form-data">
			<div class="col-md-6 mt-5">
				...
				<input type="text" class="form-control main" name="nama_kapal" id="nama_kapal" placeholder="Nama Kapal">
			</div>
...
<div class="mb-3">
  ...
  <input class="form-control form-control-sm" type="file" id="gambar_kapal" name="nama_file">
</div>
...
<div class="col-md-6">
			...
			<div class="col-12 text-center mt-4">
				<button class="btn btn-primary btn-lg btn-block" type="submit" style="margin-top:20px;" name="btnsimpan">tambah kapal</button>
...
if (isset($_POST['btnsimpan'])) {
    ...
    if ($jenis_gambar == "image/jpeg" || $jenis_gambar == "image/jpg" || $jenis_gambar == "image/gif" || $jenis_gambar == "image/png") {
        ...
        if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar_kapal)) {
            $sql = ("INSERT INTO kapal (nama_kapal,kategori_kapal,gambar_kapal,tujuan_kapal,harga) 
            VALUES ('$nama_kapal','$kategori_kapal','$gambar_kapal','$tujuan_kapal','$harga')");
