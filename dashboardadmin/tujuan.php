    ...
    <section class="section schedule">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title mt-3 ">
                        <h2>DAFTAR <span class="alternate">Tujuan Kapal</span></h2>
                    </div>
                </div>
            </div>

            <div class="icontambah mb-5" style="margin-left: 50px;">
                    <a class="btn btn-primary btn-sm" href="tambahtujuan.php" role="button"
                        title="Tambah Tujuan">
                        &nbsp;<i class="fa fa-plus" aria-hidden="true"> <label class="p-2">Tambah Tujuan Kapal</label> </i>&nbsp;
                    </a>
            </div>
            <table id="data" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                        <?php
                             $user = mysqli_query($konek, "SELECT * FROM tujuan INNER JOIN kategori ON tujuan.kategori_id = kategori.id_kategori ");
                             $no = 1;
                            ...
                            <td><img src="<?php echo $data['foto'] ?>" style="width: 150px; height: 150px;"></td>
                            <td>
                                <form action="" method="POST" >
                                    
                                    <a href="edittujuan.php?id=<?php echo $data['id_tujuan']; ?>">
                                        <button type="button" class="btn btn-warning btn-sm" title="Ubah User">
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </button>
                                    </a>
                                    <a href="hapustujuan.php?id=<?php echo $data['id_tujuan']; ?>">
