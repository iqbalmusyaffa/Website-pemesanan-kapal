...
<section class="section contact-form">
	<div class="container">
		...
		<form action="tambahkategorikapal.php" method="POST" class="row">
			<div class="col-md-6 mt-5">
                <label class="form-label fw-bold">Nama Kategori</label>
				<input type="text" class="form-control main" name="nama_kategori_kapal" id="nama_kategori_kapal" placeholder="Nama Kategori">
			</div>
			<div class="col-12 text-center mt-4">
				<button type="submit" name="btnsimpan" value="simpan" class="btn btn-success btn-md m-3">Simpan</button>
