        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title mt-3 ">
                    <h2>DAFTAR <span class="alternate">Kapal</span></h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <a class="btn btn-primary btn-sm" href="tambahkapal.php" role="button"
                    title="Tambah User">
                    &nbsp;<i class="fa fa-plus" aria-hidden="true"> <label class="p-2">Tambah Kapal</label></i>&nbsp;
                </a>
                <br /><br />
                <table id="data" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                        <?php
                             $user = mysqli_query($konek, "SELECT * FROM kapal INNER JOIN kategori ON kapal.kategori_kapal = kategori.id_kategori INNER JOIN tujuan ON kapal.tujuan_kapal = tujuan.id_tujuan");
                             $no = 1;
                            ...
                            <td><img src="<?php echo $data['gambar_kapal'] ?>" style="width: 150px; height: 150px;"></td>
                            <td><?php echo $data['tujuan'] ?></td>
                            <td><?php echo "Rp " . number_format($data['harga']) ?></td>
                            <td>
                                <form action="" method="POST" >
                                    
                                    <a href="editkapal.php?id=<?php echo $data['id_kapal']; ?>">
                                        <button type="button" class="btn btn-warning btn-sm" title="Ubah kapal">
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </button>
                                    </a>
                                    <a href="hapuskapal.php?id=<?php echo $data['id_kapal']; ?>">
                                    <button type="button" class="btn btn-danger btn-sm" name="proses" value="hapus"
                                        onclick="return confirm('Anda Yakin Data akan diHapus?')" title="Hapus kapal">
