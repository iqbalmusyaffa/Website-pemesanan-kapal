...
<section class="section schedule">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <a class="btn btn-primary btn-sm" href="tambahuser.php" role="button"
                    title="Tambah User">
                ...
                <table id="data" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                        <?php
                             $user = mysqli_query($konek, "SELECT * FROM user  ORDER BY id_user ASC");
                             $no = 1;
                            ...
                            <td>
                                <form action="" method="POST" >
                                    ...
                                    <a href="edituser.php?id=<?php echo $data['id_user']; ?>">
                                        <button type="button" class="btn btn-warning btn-sm" title="Ubah User">
                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        </button>
                                    </a>
                                    <a href="hapususer.php?id=<?php echo $data['id_user']; ?>">
